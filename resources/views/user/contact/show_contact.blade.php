                ...
                <div class="col-sm-8">
                    <div class="contact-form">
                        ...
                        <form id="form-contact" action="" method="POST" class="searchform">
                            ...
                            <div class="error error-name" @if ($errors->has('name')) style="display:block" @endif>
                                {{ $errors->first('name') }}</div>
                            <input name="email" id="contact-email" type="text" placeholder="Nhập email" />
                            <div class="error error-email" @if ($errors->has('email')) style="display:block" @endif>
                                {{ $errors->first('email') }}</div>
                            <textarea id="contact-content" name="content" rows="5" placeholder="Nhập nội dung"></textarea>
                            <div class="error error-content" @if ($errors->has('content')) style="display:block" @endif>
