...
@section('content')
    <section class="charts">
        <section>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" style="display:flex;">
                                {{-- Form delete --}}
                                <form id="delete-category" action="{{ route('admin.category.delete') }}" method="POST"
                                ...
                                <div class="card-body card-form" style="padding:0;">
                                    <form class="form-inline" style="float: right;" method="GET"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inlineFormInputGroup" value="{{ Request::get('search') }}"
                                                name="search" type="text" placeholder="Tên danh mục"
                            ...
                            <div class="card-body card-form-mob" style="padding:0;">
                                <form class="form-inline" style="float: right;" method="GET"
                                    ...
                                    <div class="form-group">
                                        <label for="inlineFormInputGroup" class="sr-only">Tên</label>
                                        <input id="inlineFormInputGroup" value="{{ Request::get('search') }}" name="search"
                                    ...
                                    <table class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Tên danh mục</th>
                                                <th scope="col">Phân loại danh mục</th>
                                                <th>Hành động</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($rows as $row)
                                                <tr>
                                                    <td><input type="checkbox" name="check" class="check cursor"
                                                            data-id="{{ $row->id }}"></td>
                                                    <td>{{ $row->name }}</td>
                                                    <td>
                                                        @if ($row->parent_id == 0)
                                                        ...
                                                        @else
                                                            @foreach ($rows as $item_sub)
                                                                @if ($item_sub->id == $row->parent_id)
                                                                    thuộc vào <b>{{ $item_sub->name }}</b>
                                                                @endif
                                                            @endforeach
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <span class="edit cursor" data-id="{{ $row->id }}"
            ...
            <div id="modal-category" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
                        ...
                        <div class="modal-body">
                            <form id="form-category" action="{{ route('admin.category.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Tên danh mục" name="name_category"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="parent_id" id="parent_id">
                                        <option value="0" style="font-weight: bold">Danh mục chính
                                        </option>
                                        @if (!empty($ketquacuoi))
