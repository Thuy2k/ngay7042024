                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="form-post" class="form-horizontal" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        ...
                                        <input id="name" type="text"
                                            ...
                                            name="name" placeholder="Tên" class="form-control" onkeyup="ChangeToSlug();">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="custom-file">
                                            <input id="path" type="text" name="path"
                                                @if ($flag) value="{{ $rows->path }}" @endif
                                                placeholder="Đường dẫn" class="form-control" readonly
                                                onkeyup="ChangeToSlug();">
                                            <div class="error error-path"
                                                @if ($errors->has('path')) style="display:block" @endif>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="custom-file">
                                            <input id="author" type="text" name="author"
                                                @if ($flag) value="{{ $rows->author }}" @endif
                                                placeholder="Tác giả" class="form-control">
                                            <div class="error error-author"
                                                @if ($errors->has('author')) style="display:block" @endif>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select name="post_cate_id" id="post_cate" class="form-control">
                                            @foreach ($post_cates as $key => $post)
                                                <option @if ($flag && $rows->post_name == $post->post_name) selected @endif
                                                    value="{{ $post->id }}">{{ $post->post_name }}</option>
                                            @endforeach
                                        </select>
                                        <div class="error error-post"
                                            @if ($errors->has('post')) style="display:block" @endif>
                                            {{ $errors->first('post') }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea id="description" rows="5" name="description" placeholder="Nhập mô tả" class="form-control">
@if ($flag)
{{ $rows->description }}
@endif
</textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea id="content" rows="5" name="content" placeholder="Nội dung" class="form-control">
@if ($flag)
{{ $rows->post_content }}
@endif
</textarea>
                                        <div class="error error-content"
                                            @if ($errors->has('content')) style="display:block" @endif>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        ...
                                        <img width="200px" height="200px" id="ImgPre"
                                            @if ($flag && !empty($primary)) src="{{ asset($primary->path) }}" @else src="{{ asset('images/post/no-image-post.png') }}" @endif
