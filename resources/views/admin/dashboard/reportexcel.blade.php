<table>
    <thead>
        ...
        <tr>
            <th colspan="9"
                style="text-align:center;color:red;background-color:yellow;font-weight:bold;font-size: 16px;">Thống kê
                hoá đơn</th>
        </tr>
        <tr></tr>
        <tr>
            ...
            <th>{{ config('app.name', 'Bảo An Luxury') }}</th>
        ...
        <tr>
            <th
                style="font-weight:bold;color:white;background-color:blue;border-bottom:1px black solid;border-right:1px black solid">
                STT</th>
            <th
                style="font-weight:bold;color:white;background-color:blue;border-bottom:1px black solid;border-right:1px black solid">
                Mã đơn hàng</th>
    ...
    <tbody>
        ...
        @foreach ($orders as $key => $order)
            ...
            <tr>
                ...
                <td style="border:1px black solid;vertical-align: text-top;">
                    {{ getMethodPaymentDashboard($order->method) }}</td>
