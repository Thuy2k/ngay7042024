                        ...
                        <div class="form-inner" style="width:100%">
                            <form method="post" action="{{ route('register.post') }}" id="form-register" class="text-left">
                                ...
                                <center> <a href="{{ route('home') }}"><img width="100px"
                                            src="{{ 'user/images//home/logo.png' }}" alt="" /></a></center>
                                <br />
                                <div class="form-group-material">
                                    ...
                                    <div class="error error-username"
                                        @if ($errors->has('username')) style="display:block" @endif>
                                ...
                                <div class="form-group-material">
                                    <input id="register-confirm_password" type="password" name="confirm_password"
                                ...
                                <div class="form-group text-center">
                                    <span style="background-color:#FE980F;border-color:#FE980F" id="register"
                                        class="btn btn-custom btn-primary">Đăng ký</span>
