                        ...
                        <div class="form-inner" style="width:100%">
                            <form method="post" id="form-login" class="text-left" action="{{ route('login') }}">
                                ...
                                <div class="form-group-material">
                                    <input id="login-email" value="{{ $arr->email ?? '' }}" autocomplete="email" autofocus
                                        type="text" name="email" class="input-material">
                                ...
                                <div class="form-group-material">
                                    <input value="{{ $arr->password ?? '' }}" id="login-password"
                                ...
                                <div class="form-group-material">
                                    <input id="remember" type="checkbox" {{ !empty($arr) ? 'checked' : '' }}
                                        name="remember" class="" value="0"
                                        style="border: #fff 1px solid !important;">
                                    <label style="color:#aaa;display: inline;padding-left: 10px;" for="option">Nhớ mật
                                        khẩu</label>
                                </div>
                                <div class="form-group text-center">
                                    <button style="submit" style="background-color:#FE980F;border-color:#FE980F"
                                        id="login" type="submit" class="btn btn-primary btn-custom">Đăng nhập</button>
                                    <!-- This should be submit button but I replaced it with <a> for demo purposes-->
                                </div>
                            </form>
                            <a href="{{ route('password.update') }}" class="forgot-pass">Quên mật khẩu?</a>
                            <small>Bạn chưa có tài khoản? </small><a href="{{ route('register.get') }}"
                                class="signup ">Đăng ký</a>
                        </div>
